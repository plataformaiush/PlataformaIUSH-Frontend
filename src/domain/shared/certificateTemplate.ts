import { InstitutionColors } from '../institution/types'

/**
 * Genera el HTML del certificado personalizado con los colores de la institución
 */
export function buildCertificateHtml(logo: string, colors: InstitutionColors): string {
  return `<!DOCTYPE html>
<html lang="es">
<head>
<meta charset="UTF-8" />
